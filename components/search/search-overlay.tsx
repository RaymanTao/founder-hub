  ...
  return (
    <>
      ...
      {open && typeof document !== "undefined" ? createPortal(
        <div className="fixed inset-0 z-[70] flex min-h-screen items-start justify-center overflow-y-auto bg-black/45 px-4 pb-8 pt-[10vh] backdrop-blur-[3px] sm:pt-[12vh]" onMouseDown={(event) => { if (event.target === event.currentTarget) setOpen(false); }}>
